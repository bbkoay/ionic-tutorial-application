...
.controller('SessionTwitterFeedCtrl', function($scope, $stateParams, Session, Speaker) {
    if (pageReload == true){
...
.controller('SpeakerTwitterFeedCtrl', function($scope, $stateParams, Session, Speaker) {
    if (pageReload == true){
		window.location.reload();
		pageReload = false;
	}
